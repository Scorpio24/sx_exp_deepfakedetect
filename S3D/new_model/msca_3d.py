...
class AttentionModule(nn.Module):
    def __init__(self, dim, time_size):
        ...
        # self.conv0_2 = DWSepConv3d(dim, (time_size, 5, 1), padding=(time_padding, 2, 0))

        self.conv1_1 = DWSepConv3d(dim, (time_size, 7, 7), padding=(time_padding, 3, 3))
        # self.conv1_2 = DWSepConv3d(dim, (time_size, 7, 1), padding=(time_padding, 3, 0))

        self.conv2_1 = DWSepConv3d(dim, (time_size, 11, 11), padding=(time_padding, 5, 5))
        # self.conv2_2 = DWSepConv3d(dim, (time_size, 11, 1), padding=(time_padding, 5, 0))
