...
class msca_S3D(nn.Module):
    def __init__(self, num_class, SRM_net):
        ...
        self.base = nn.Sequential( # input:bs*(3/30) *20*224*224
            ...
            iFormerBlock_light(192, 1/3, 1),#out:bs*128*10*28*28
            iFormerBlock(192, 1/3, 1),#out:bs*128*10*28*28
            ...
            iFormerBlock_light(320, 4/5, 3),#out:bs*128*10*28*28
            iFormerBlock_light(320, 4/5, 3),#out:bs*128*10*28*28
            iFormerBlock(320, 4/5, 3),#out:bs*128*10*28*28
